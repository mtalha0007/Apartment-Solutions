...
const initialData = [
  {
    ...
    managmentCompany: "NovaWaveLLC",
    address: "161 Bayonne Ave",
    location: "Germany",
    contactName: "Hendry",
          ...
          <TableBody>
            {paginatedData.map((row) => (
              <TableRow key={row.id}>
                ...
                <TableCell sx={{textAlign:'center'}}>{row.managmentCompany}</TableCell>
                <TableCell sx={{textAlign:'center'}}>{row.address}</TableCell>
                <TableCell sx={{textAlign:'center'}}>{row.location}</TableCell>
                <TableCell sx={{textAlign:'center'}}>{row.contactName}</TableCell>
